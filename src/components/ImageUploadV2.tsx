import { borderBottomLeftRadius, borderBottomRightRadius, borderTopLeftRadius, borderTopRightRadius } from "html2canvas/dist/types/css/property-descriptors/border-radius";
...
function ImageUploadV2({ setReferenceImages }: Props) {
	...
	return (
		<section className="w-full sm:w-[99%] lg:w-[85%] xl:w-[85%] md:w-[90%] h-1/2 sm:mb-32 lg:mb-1">
			{/* eslint-disable-next-line @typescript-eslint/no-explicit-any */}
			<div {...getRootProps({ style: {...style, backgroundColor: '#0F1021', borderColor: '12px dashed black', borderTopLeftRadius: 10, borderTopRightRadius: 10, borderBottomLeftRadius: 10, borderBottomRightRadius: 10 } as any })}>
				<input {...getInputProps()} />
				...
				<div className="text-lg mt-10 lg:mt-12 text-slate-500">
					<p>max 10MB</p>
				</div>
			</div>
		</section>

...
function OutputSettingsSection({
	...
	return (
		<div className={ (appState == AppState.INITIAL) ? "flex flex-col justify-between text-sm mt-4":"hidden"}>
				...
				{appState === AppState.INITIAL && <><span className="mt-3 mb-4 text-white">Select language:</span><div className="grid grid-rows-2 gap-4">
					<div className="flex flex-col w-full">
						<button
							...
							onClick={() => setGeneratedCodeConfig(GeneratedCodeConfig.HTML_TAILWIND)}
						...
						<button
							...
							onClick={() => setGeneratedCodeConfig(GeneratedCodeConfig.REACT_TAILWIND)}
							disabled={shouldDisableUpdates}
						>
						...
						<button
							...
							onClick={() => setGeneratedCodeConfig(GeneratedCodeConfig.BOOTSTRAP)}
							disabled={shouldDisableUpdates}
						>
						...
						<button
							...
							onClick={() => setGeneratedCodeConfig(GeneratedCodeConfig.IONIC_TAILWIND)}
							disabled={shouldDisableUpdates}
						>

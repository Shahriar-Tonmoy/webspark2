...
export default function Screenshort(props: {cookie: string, Generate: generate, SetAppState: setAppstate}) {
    ...
    return (<section className={(data == null)?"w-3/4 lg:w-1/2 lg:h-[65%]":"flex w-3/4 lg:w-1/2 lg:h-[65%] bg-[#17212A]"}>
        {errormodal && <URLErrorModal setclose={modalclose} />}
        {(data == null && !btnclicked) && <div className="flex flex-col bg-[#17212A] border-2 border-white border-dashed content-center justify-center p-2 h-full w-ful">
